      ...
      <div class="navbar-menu-wrapper d-flex align-items-top">
        <ul class="navbar-nav">
          <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
            <h1 class="welcome-text">Merhaba, <span class="text-black fw-bold"><?=$user->getFullName()?></span></h1>
        ...
        <ul class="navbar-nav ms-auto">
          <li class="nav-item dropdown d-none d-lg-block user-dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
              ...
              <a class="dropdown-item"><i class="dropdown-item-icon mdi mdi-power text-primary me-2"></i>Çıkış Yap</a>
            </div>
          </li>
        </ul>
        ...
        <ul class="nav">
          <li class="nav-item">
            <a class="nav-link" href="index.php">
              ...
              <span class="menu-title">Slide Yönetimi</span>
            </a>
          </li>
          <li class="nav-item">
